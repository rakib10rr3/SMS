...
class CreateSubjectsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('subjects', function (Blueprint $table) {
            ...
            $table->string('code');
            $table->string('name');
            $table->float('full_marks',5,2)->nullable();
            $table->float('pass_marks',5,2)->nullable();
            $table->float('written_marks',5,2)->nullable();
            $table->float('written_pass_marks',5,2)->nullable();
            $table->float('mcq_marks',5,2)->nullable();
