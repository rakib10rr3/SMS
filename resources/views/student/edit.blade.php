                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control date-picker" placeholder="Select Date" id="dob"
                                       name="dob" value="{{ Carbon\Carbon::parse($student->dob)->format('d F Y')
}}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="local_guardian_name"
                                       name="local_guardian_name" value="{{$student->local_guardian_name}}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="local_guardian_cell"
                                       name="local_guardian_cell" value="{{$student->local_guardian_cell}}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="current_address" name="current_address">{{$student->current_address}}</textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                ...
                <section>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Roll :</label>
                                <input type="number" class="form-control" id="roll" name="roll" min="1" value="{{$student->roll}}">
                            </div>
                            <div class="form-group">
                                <label>Shift :</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control date-picker" placeholder="Select Date"
                                       id="admission_year"
                                       name="admission_year" value="{{ Carbon\Carbon::parse($student->admission_year)->format('d F Y')
}}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="extra_activity" name="extra_activity">{{$student->extra_activity}}</textarea>
                            </div>
