                    ...
                    <section>
                        ...
                        <div id="written_hidden">
                         <div>
                            ...
                            <input type="text" name="written_marks" class="form-control" placeholder="Written Marks">
                         </div>
                        <div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label>Has MCQ?</label>
                                    <input type="checkbox" class="switch-btn" data-color="#0059b2" id="mcq">
                                </div>
                            </div>
                        </div>
                        <div id="mcq_hidden">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input name="has_practical" type="checkbox" class="switch-btn" data-color="#0059b2" id="practical">
                                </div>
                            </div>
                        </div>
                        <div id="mcq_hidden">
                            <div>
                                ...
                                <input type="text" name="practical_marks" class="form-control" placeholder="Practical Marks">
                            </div>
                            <div>
                        ...
                        <div class="mb-30">
                            ...
                            <input name="is_optional" type="checkbox" class="switch-btn" data-color="#0059b2">
                        </div>
                    </section>
                </form>
            </div>
