            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="custom-select form-control" id="religion_id" name="the_class_id">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="custom-select form-control" id="religion_id" name="shift_id">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="custom-select form-control" id="religion_id" name="section_id">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="custom-select form-control" id="religion_id" name="subject_id">
