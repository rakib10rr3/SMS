...
@section('content')
    ...
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
        <div class="clearfix">
            <div align="center">
                <h4 class="text-danger">View Attendance</h4>
            </div>
        </div>
    </div>
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select2 form-control" id="shift_id" name="shift_id">
                            ...
                            @foreach($shifts as $shift)
                                <option value="{{$shift->id}}" {{(old('shift_id') == $shift->id?'selected':'')}}>{{$shift->name}}>{{$shift->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select2 form-control" id="section_id" name="section_id">
                            ...
                            @foreach($sections as $section)
                                <option value="{{$section->id}}" {{(old('section_id') == $section->id?'selected':'')}}>{{$section->name}}>{{$section->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
